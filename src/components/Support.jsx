...
import {ChatIcon, SupportIcon} from "@heroicons/react/solid";
import supportImg from '../assets/xl_salmon.png';
        ...
        <div className='w-full h-screen mt-24'>
            ...
            <div className='max-w-[1240px] mx-auto text-white relative'>
                <div className='px-4 py-12'>
                    <h2 className='p-8 text-slate-300 uppercase text-center text-3xl'>Support</h2>
                    <h3 className='text-5xl font-bold py-6 text-center'>Finding the right team</h3>
                    <p className='py-4 text-3xl text-slate-300'>This is some text</p>
                </div>
